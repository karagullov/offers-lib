...
export const StyledDiv = styled.div.attrs(
  ...
  background-color: ${({ theme, themeBgColor }) =>
    themeBgColor ? theme[themeBgColor] : ""};
...
export const LoadingDiv = styled(StyledDiv).attrs(
  (props: DivStyledComponentProps) => {
    return {
  ...
  ${({ fontSizePreset: fontPreset }) =>
    `height: ${toLineProps(fontPreset)?.height ?? ""};`}
