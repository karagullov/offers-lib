import { getUniversalAttrs } from "pages/AtomX/interfaces/universal-styled-component-props";
...
export const DefaultFlex = styled.div.attrs(
  getUniversalAttrs
)<FlexStyledComponentProps>`
  display: ${(props) => props.display || "flex"};
